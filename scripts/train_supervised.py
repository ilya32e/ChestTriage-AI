...
from radiology_triage.training.supervised import run_supervised_experiment  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train a supervised ChestMNIST model.")
