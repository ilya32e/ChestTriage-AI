...
Get-CimInstance Win32_Process |
    Where-Object { $_.CommandLine -like '*run_real_project.ps1*' -or $_.CommandLine -like '*run_final_project.ps1*' } |
...
$runner = Start-Process powershell `
    -ArgumentList '-ExecutionPolicy','Bypass','-File','.\\scripts\\run_final_project.ps1' `
    -WorkingDirectory $projectRoot `
